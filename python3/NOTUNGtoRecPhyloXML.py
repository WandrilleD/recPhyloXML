...
def NotungAnnotationToRecEvent(annot):
    ...
    if "H" in annot:# transfer reception
    ...
    if ( evtType is None ) or ( evtType=='Tb' ): # second case : Transfert back followed by speciation, speciation loss or leaf
...
def read_leaf(s):
    ...
    evts = NotungAnnotationToRecEvent(annot)
